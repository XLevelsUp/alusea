...
export default function CatalogueClient({ initialProducts }: { initialProducts: Product[] }) {
  ...
  return (
    <main className="min-h-screen bg-white dark:bg-matte-black pt-24 pb-0 flex flex-col">
      ...
      {/* Catalogue Grid */}
      <section className="w-full max-w-[1440px] mx-auto px-6 md:px-12 py-12 md:py-20 flex-grow">
        <motion.div 
        ...
        >
          {products.map((product) => (
            ...
            >
              ...
              <div className="relative w-full h-[320px] xl:h-[380px] overflow-hidden bg-gray-100 dark:bg-[#0a0a0a]">
                <Image
