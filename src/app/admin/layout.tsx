      ...
      {user && (
        <aside className="w-64 bg-matte-black text-white p-6 hidden md:block">
          ...
          <nav className="space-y-4">
            ...
            <Link href="/admin/categories" className="block px-4 py-3 rounded-md bg-white/10 hover:bg-white/20 transition-colors cursor-pointer font-medium tracking-wide">
              Categories
            </Link>
