    ...
    <div className="p-8 max-w-7xl mx-auto w-full relative">
                ...
                <tr key={post.id} className="hover:bg-gray-50/50 transition-colors">
                  ...
                  <td className="p-4 align-top text-right">
                    <div className="flex items-center justify-end gap-2">
                      <Link href={`/blog/${post.slug}`} target="_blank" className="text-gray-500 hover:text-gray-700 text-xs font-semibold uppercase tracking-wider px-3 py-1 border border-gray-200 hover:bg-gray-50 rounded transition-colors">
                        View
                      </Link>
                      <Link href={`/admin/blog/${post.id}/edit`} className="text-blue-500 hover:text-blue-700 text-xs font-semibold uppercase tracking-wider px-3 py-1 border border-blue-200 hover:bg-blue-50 rounded transition-colors">
                        Edit
                      </Link>
      ...
      {!!pendingCommentsCount && pendingCommentsCount > 0 && (
        <p className="mt-4 text-sm text-gray-500">
          ...
          <Link href="/admin/blog/comments" className="text-[#A67C52] font-semibold hover:underline">
            Review them
          </Link>
        </p>
      )}
